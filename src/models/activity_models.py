...
class UserPreferences:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'UserPreferences':
        ...
        preferences = cls(
            ...
            favorite_categories=[ActivityCategory(cat) for cat in data.get('favorite_categories', [])],
...
EQUIPMENT_CATEGORIES = {
    'fitness': [
        'yoga mat', 'dumbbells', 'resistance bands', 'running shoes',
        'water bottle', 'towel', 'fitness tracker'
    ],
    'outdoor': [
        'hiking boots', 'backpack', 'sunscreen', 'hat', 'sunglasses',
        'first aid kit', 'map', 'compass', 'flashlight'
    ],
    'creative': [
        'sketchbook', 'pencils', 'paints', 'brushes', 'camera',
        'notebook', 'pens', 'craft supplies'
    ],
    'sports': [
        'ball', 'racket', 'helmet', 'protective gear', 'cleats',
        'gloves', 'sports bag'
    ],
    'water': [
        'swimsuit', 'goggles', 'towel', 'sunscreen', 'life jacket',
        'snorkel', 'fins'
    ]
}
