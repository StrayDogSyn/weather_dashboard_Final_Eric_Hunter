...
class ConfigService(IConfigurationService):
    ...
    def weather(self) -> WeatherConfig:
        """Get the weather configuration (backward compatibility)."""
        return self._config.weather

    @property
    def ui(self) -> UIConfig:
        """Get the UI configuration (backward compatibility)."""
        return self._config.ui

    @property
    def app(self) -> AppConfig:
        """Get the app configuration (backward compatibility)."""
        return self._config
