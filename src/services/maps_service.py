...
class GoogleMapsService:
    ...
    def _make_request(self, endpoint: str, params: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if data.get("status") != "OK":
                self.logger.error(
                    f"❌ Maps API error: {data.get('status')} - {data.get('error_message', 'Unknown error')}"
                )
                return None
    ...
    def reverse_geocode(self, latitude: float, longitude: float) -> Optional[GeocodeResult]:
        ...
        try:
            ...
            params = {"latlng": f"{latitude},{longitude}", "language": "en"}
    ...
    def get_directions(
        ...
        try:
            ...
            params = {"origin": origin, "destination": destination, "mode": mode, "language": "en"}
