...
class AutoRefreshComponent(ctk.CTkFrame):
    ...
    def _create_refresh_ui(self):
        ...
        self.refresh_progress.grid(row=1, column=0, columnspan=4, padx=15, pady=(0, 10), sticky="ew")
...
class LoadingOverlay(ctk.CTkFrame):
    ...
    def _animate_spinner(self):
        ...
        self.spinner_label.configure(text=spinner_frames[self.animation_frame % len(spinner_frames)])
