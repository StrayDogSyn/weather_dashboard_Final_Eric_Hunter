...
class WeatherJournalUI(ctk.CTkFrame):
    ...
    def _create_ui(self):
        ...
        self.notes_text = ctk.CTkTextbox(
            self.entry_frame, height=100, fg_color="#2A2A2A", border_color="#333333", border_width=1
        )
    ...
    def _save_entry(self):
        ...
        if (
            ...
            and hasattr(self, "dashboard")
            and hasattr(self.dashboard, "current_weather")
        ):
    ...
    def _create_entry_widget(self, entry):
        ...
        date_label = ctk.CTkLabel(
            header_frame, text=date_str, font=("JetBrains Mono", 11, "bold"), text_color="#00FFAB"
        )
        ...
        weather_label = ctk.CTkLabel(
            entry_frame, text=weather_info, font=("JetBrains Mono", 10), text_color="#B0B0B0"
        )
