...
class SearchBar(ctk.CTkFrame):
    ...
    def __init__(self, parent, on_search=None, on_location_selected=None, 
                 placeholder="🔍 Enter city name...", **kwargs):
    ...
    def _setup_enhanced_interactions(self):
        ...
        try:
            ...
            from src.ui.components import AnimationManager, MicroInteractions
        ...
        if search_term:
            ...
            if self.animation_manager:
                self.animation_manager.fade_out(
                    self.search_entry, 
                    callback=lambda: self.search_entry.delete(0, "end")
                )
            else:
...
class EnhancedSearchBar(SearchBar):
    ...
    def show_suggestions(self, suggestions):
        ...
        for suggestion in suggestions[:5]:  # Limit to 5 suggestions
            ...
            label.bind("<Enter>", lambda e, l=label: l.configure(text_color=DataTerminalTheme.PRIMARY))
