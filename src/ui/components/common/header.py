...
class HeaderComponent(ctk.CTkFrame):
    ...
    def _setup_header(self):
        ...
        if EnhancedSearchBar and self.on_search_callback:
            try:
                ...
                self.search_bar.grid(row=0, column=0, sticky="ew", pady=LayoutStyles.PADDING["small"])
            except Exception:
    ...
    def _create_basic_search(self, parent):
        ...
        self.search_entry = ctk.CTkEntry(
            ...
            **ComponentStyles.SEARCH_ENTRY
        )
        self.search_entry.grid(row=0, column=0, sticky="ew", padx=(0, LayoutStyles.SPACING["normal"]))
