...
class WeatherDataGenerator:
    ...
    def generate_comprehensive_data(self, timeframe: str, location: str = "Default") -> Dict[str, Any]:
    ...
    def generate_historical_comparison_data(self, timeframe: str, years_back: int = 5) -> Dict[str, Any]:
