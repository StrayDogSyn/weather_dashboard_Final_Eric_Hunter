...
class AnimationManager:
    ...
    def fade_in(self, widget: ctk.CTkBaseClass, duration: int = 300, callback: Optional[Callable] = None):
    ...
    def fade_out(self, widget: ctk.CTkBaseClass, duration: int = 300, callback: Optional[Callable] = None):
    ...
    def slide_in(self, widget: ctk.CTkBaseClass, direction: str = "left", duration: int = 400, distance: int = 100):
    ...
    def number_transition(self, label: ctk.CTkLabel, start_value: float, end_value: float, duration: int = 500, format_str: str = "{:.1f}"):
