...
class UserFriendlyLogger:
    ...
    def get_user_friendly_message(self, exception: Exception) -> str:
        ...
        if "api key" in error_str or "unauthorized" in error_str:
            return "There's an issue with the weather service authentication. Please contact support."
        ...
        return self.user_messages.get(exception_type, 
...
class BugReportDialog:
    ...
    def _create_widgets(self):
        ...
        error_label = ttk.Label(
            error_frame,
            text=self.error_report.user_message,
            wraplength=500,
            justify="left"
        )
        ...
        self.steps_text.insert("1.0", "Please describe what you were doing when the error occurred...")
...
class DiagnosticsManager:
    ...
    def _show_user_error(self, error_report: ErrorReport):
        ...
        try:
            ...
            ttk.Button(
                ...
                command=lambda: self._show_diagnostics(dialog)
            ).pack(side="left", padx=(0, 10))
        ...
        def run_diagnostics():
            ...
            def run_tests():
                try:
                    ...
                    self.parent.after(0, lambda: self._show_diagnostics_results(results, progress_dialog))
                except Exception as e:
                    self.parent.after(0, lambda: self._show_diagnostics_error(str(e), progress_dialog))
    ...
    def _show_diagnostics_error(self, error: str, progress_dialog: tk.Toplevel):
        ...
        messagebox.showerror(
            "Diagnostics Error",
            f"Failed to run diagnostics: {error}"
        )
