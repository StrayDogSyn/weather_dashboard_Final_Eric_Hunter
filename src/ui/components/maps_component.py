...
from services.maps_service import GoogleMapsService, PlaceResult, GeocodeResult, DirectionsResult
...
class MapsComponent(ctk.CTkFrame):
    ...
    def __init__(self, parent, config_service: ConfigService, on_location_selected: Optional[Callable] = None):
