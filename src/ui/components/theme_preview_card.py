...
class ThemePreviewCard(ctk.CTkFrame):
    ...
    def __init__(self, parent, theme_data: Dict[str, Any], theme_key: str, on_select: Callable[[str], None]):
    ...
    def _create_widgets(self):
        ...
        self.swatches_frame = ctk.CTkFrame(
            self,
    ...
    def set_selected(self, selected: bool):
        ...
        if selected:
            self.configure(
                border_color=self.theme_data["accent"],
                border_width=3
            )
    ...
    def update_colors(self, new_theme_data: Dict[str, Any]):
        ...
        self.configure(
            ...
            border_color=new_theme_data["primary"] if not self.is_selected else new_theme_data["accent"]
        )
