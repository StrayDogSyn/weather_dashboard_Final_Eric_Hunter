...
class AIProvidersMixin:
    ...
    def _get_enhanced_ai_suggestions(self, weather_data: Dict, user_preferences: List[Dict]) -> List[Dict]:
    ...
    def _get_legacy_ai_suggestions(self, weather_data: Dict, user_preferences: List[Dict]) -> List[Dict]:
    ...
    def _get_gemini_suggestions(self, weather_data: Dict, user_preferences: List[Dict]) -> List[Dict]:
    ...
    def _get_openai_suggestions(self, weather_data: Dict, user_preferences: List[Dict]) -> List[Dict]:
        ...
        try:
            ...
            response = self.openai_client.chat.completions.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": "You are a helpful activity suggestion assistant."},
                ...
                for suggestion in suggestions:
                    if isinstance(suggestion, dict) and 'name' in suggestion:
                        ...
                        cleaned_suggestion = {
                            ...
                            'weather_suitability': suggestion.get('weather_suitability', 'Suitable for current conditions')
                        }
