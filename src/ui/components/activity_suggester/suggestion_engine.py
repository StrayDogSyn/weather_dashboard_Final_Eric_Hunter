...
class SuggestionEngineMixin:
    ...
    def _fetch_suggestions(self) -> None:
        ...
        try:
            ...
            try:
                ...
                if (
                    not ai_suggestions
                    and hasattr(self, "openai_available")
    ...
    def _generate_enhanced_ai_suggestions(self) -> List[Dict]:
        ...
        try:
            ...
            response = self.ai_service.generate_activity_suggestions(
                weather_data=self.current_weather, user_preferences=preferences
            )
    ...
    def _show_activity_details(self, activity: Dict) -> None:
        ...
        try:
            ...
            # Main frame
            main_frame = ctk.CTkScrollableFrame(details_window, fg_color=DataTerminalTheme.CARD_BG)
