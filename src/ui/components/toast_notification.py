...
class ToastNotification:
    ...
    def __init__(self, parent: tk.Widget, config: ToastConfig, 
...
class ToastManager:
    ...
    def show_toast(self, toast_type: ToastType, message: str, 
                   duration: Optional[float] = None,
                   action_text: Optional[str] = None,
                   action_callback: Optional[Callable] = None,
                   dismissible: bool = True) -> ToastNotification:
    ...
    def show_error(self, message: str, action_text: str = None, 
                   action_callback: Callable = None) -> ToastNotification:
