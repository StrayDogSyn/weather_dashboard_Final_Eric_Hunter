...
class ToolTip:
    ...
    def _schedule_show(self):
        ...
        self._cancel_show()
        self.show_timer = self.widget.after(
            int(self.config.delay * 1000), 
            self._show_tooltip
        )
...
class OnboardingOverlay:
    ...
    def _create_overlay(self):
        ...
        self.overlay_window.geometry(f"{self.parent.winfo_screenwidth()}x{self.parent.winfo_screenheight()}+0+0")
...
class FeatureDiscovery:
    ...
    def highlight_feature(self, widget: tk.Widget, feature_name: str, 
                         description: str, duration: float = 3.0):
    ...
    def _show_feature_tooltip(self, widget: tk.Widget, description: str):
        ...
        tooltip_config = TooltipConfig(
            text=f"✨ New Feature: {description}",
            bg_color="#f39c12",
            fg_color="white"
        )
