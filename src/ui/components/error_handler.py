...
from .error_states import OfflineIndicator, APIErrorDisplay, LoadingState, InputValidationError
from .help_system import ToolTip, OnboardingOverlay, KeyboardShortcutOverlay, FeatureDiscovery
from .diagnostics import DiagnosticsManager, UserFriendlyLogger, ErrorReport
...
class ErrorHandler:
    ...
    @contextmanager
    def error_context(self, context: str, show_loading: bool = False, 
                     loading_parent: tk.Widget = None):
    ...
    def show_loading(self, parent: tk.Widget, message: str = "Loading...", 
                    show_progress: bool = False) -> LoadingState:
        """Show loading state."""
    ...
    def show_network_error(self, message: str, context: str):
        ...
        self.show_error_toast(
            f"{message} Check your internet connection.",
            persistent=True
        )
...
def handle_errors(error_handler: ErrorHandler, context: str = "", 
                 show_loading: bool = False, show_success: bool = False):
    """Decorator for automatic error handling."""
    def decorator(func):
            ...
            try:
                ...
                if show_loading and hasattr(args[0], 'master'):
                    loading_state = error_handler.show_loading(
                        args[0].master, 
                        f"Loading {context or func.__name__}..."
                    )
