...
class EnhancedJournalUI(ctk.CTkFrame):
    ...
    def _create_sidebar(self):
        ...
        self.entries_scroll = ctk.CTkScrollableFrame(
            sidebar_frame, fg_color="#2A2A2A", corner_radius=8
        )
    ...
    def _create_right_panel(self):
        ...
        self.mood_value_label = ctk.CTkLabel(
            mood_section, text="5/10", font=("JetBrains Mono", 10), text_color="#B0B0B0"
        )
    ...
    def _create_analytics_panel(self):
        ...
        self.analytics_component = MoodAnalyticsComponent(analytics_frame, self.journal_service)
        self.analytics_component.get_frame().grid(
    ...
    def _create_entry_widget(self, entry: JournalEntry, index: int):
        ...
        date_label = ctk.CTkLabel(
            entry_frame, text=date_str, font=("JetBrains Mono", 9), text_color="#B0B0B0", anchor="w"
        )
    ...
    def _filter_entries(self, *args):
        ...
        filtered_entries = [
            ...
            if search_term in (entry.title or "").lower()
            or search_term in (entry.content or "").lower()
            or search_term in (entry.tags or "").lower()
        ]
