...
class EnhancedWeatherDisplay(ctk.CTkFrame):
    ...
    def _create_weather_ui(self):
        ...
        self.extended_frame = ctk.CTkFrame(self, fg_color="transparent")
    ...
    def _create_current_conditions(self):
        ...
        self.condition_icon = ctk.CTkLabel(condition_frame, text="🌤️", font=ctk.CTkFont(size=20))
        ...
        self.weather_icon = ctk.CTkLabel(
            self.main_weather_frame, text="🌤️", font=ctk.CTkFont(size=72)
        )
    ...
    def _create_air_quality_card(self):
        ...
        self.aqi_progress = ctk.CTkProgressBar(
            self.air_quality_frame, width=200, height=8, progress_color=DataTerminalTheme.PRIMARY
        )
        ...
        self.aqi_recommendation.grid(
            row=4, column=0, columnspan=2, padx=15, pady=(0, 15), sticky="ew"
        )
    ...
    def _create_astronomical_card(self):
        ...
        # Moon phase visual
        self.moon_visual = ctk.CTkLabel(self.astro_frame, text="🌑", font=ctk.CTkFont(size=32))
    ...
    def _create_alerts_section(self):
        ...
        self.alerts_content = ctk.CTkScrollableFrame(
            self.alerts_frame, fg_color="transparent", height=100
        )
    ...
    def _update_weather_details(self, current: Dict[str, Any]):
        ...
        self.uv_index_label.configure(
            text=f"☀️ UV Index: {uv:.0f} ({self._get_uv_description(uv)})", text_color=uv_color
        )
    ...
    def _create_alert_item(self, alert: Dict[str, Any], index: int):
        ...
        alert_frame = ctk.CTkFrame(
            self.alerts_content, fg_color=DataTerminalTheme.BACKGROUND, corner_radius=6
        )
