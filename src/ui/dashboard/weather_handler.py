...
class WeatherHandlerMixin:
    ...
    def _perform_weather_update(self) -> None:
        ...
        try:
            ...
            if (
                not hasattr(self, "current_city")
                or not self.current_city
                or self.current_city.strip() == ""
            ):
            ...
            if self.winfo_exists():
                self.ui_updater.schedule_update(
                    lambda: self._safe_update_status("Fetching weather data...", "loading")
                )
            ...
            if weather_data:
                ...
                if self.winfo_exists():
                    self.ui_updater.schedule_update(
                        lambda: self._update_weather_display(weather_data)
                    )
                ...
                if self.winfo_exists():
                    ...
                    self.ui_updater.schedule_update(
                        lambda: self._safe_update_status(
                            f"Weather data updated for {location}", "success"
                        )
                    )
                ...
                if self.winfo_exists():
                    self.ui_updater.schedule_update(
                        lambda: self._safe_update_connection_status(True)
                    )
                ...
                if self.winfo_exists():
                    self.ui_updater.schedule_update(
                        lambda: self._safe_update_status("No weather data available", "warning")
                    )
        ...
        try:
            ...
            if weather_data and "error" not in weather_data:
                ...
                if isinstance(weather_data, dict):
                    self.logger.warning(
                        f"Weather service returned error: {weather_data.get('error', 'Unknown error')}"
                    )
                else:
    ...
    def _update_weather_display(self, weather_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if hasattr(self, "enhanced_weather_display") and self.enhanced_weather_display:
                if (
                    hasattr(self.enhanced_weather_display, "winfo_exists")
                    and self.enhanced_weather_display.winfo_exists()
                ):
    ...
    def _update_basic_weather_display(self, weather_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if (
                ...
                and hasattr(self, "temp_label")
                and self.temp_label.winfo_exists()
            ):
            ...
            if (
                ...
                and hasattr(self, "condition_label")
                and self.condition_label.winfo_exists()
            ):
            ...
            if (
                "feels_like" in weather_data
                and hasattr(self, "feels_like_label")
                and self.feels_like_label.winfo_exists()
            ):
            ...
            if (
                ...
                and hasattr(self, "humidity_label")
                and self.humidity_label.winfo_exists()
            ):
            ...
            if (
                ...
                and hasattr(self, "wind_label")
                and self.wind_label.winfo_exists()
            ):
