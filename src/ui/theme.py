...
class WeatherTheme:
    ...
    def __init__(self):
        ...
        self.fonts = {
            ...
            'subheading': (DataTerminalTheme.FONT_FAMILY, DataTerminalTheme.FONT_SIZE_MEDIUM, 'bold'),
            ...
            'small_bold': (DataTerminalTheme.FONT_FAMILY, DataTerminalTheme.FONT_SIZE_SMALL, 'bold'),
