...
class JournalTab(SafeCTkFrame):
    ...
    def _create_header(self):
        ...
        try:
            ...
            refresh_btn = ctk.CTkButton(
                controls_frame, text="🔄", command=self._safe_refresh, width=40, height=32
            )
    ...
    def _create_journal_list(self):
        ...
        try:
            ...
            self._ui_components["entries_list"] = SafeCTkScrollableFrame(
                list_frame, fg_color=DataTerminalTheme.SURFACE
            )
    ...
    def _create_entry_metadata(self, parent):
        ...
        try:
            ...
            mood_label = ctk.CTkLabel(
                metadata_frame, text="Mood:", font=(DataTerminalTheme.FONT_FAMILY, 12)
            )
            ...
            tags_label = ctk.CTkLabel(
                metadata_frame, text="Tags:", font=(DataTerminalTheme.FONT_FAMILY, 12)
            )
    ...
    def _create_text_editor(self, parent):
        ...
        try:
            ...
            self._ui_components["content_text"] = SafeCTkTextbox(
                parent, font=(DataTerminalTheme.FONT_FAMILY, 14), wrap="word", height=400
            )
    ...
    def _safe_add_photo(self):
        ...
        try:
            ...
            if "content_text" in self._ui_components:
                self._ui_components["content_text"].get("1.0", "end-1c")
                photo_ref = f"\n\n[Photo: {file_path}]\n"
        ...
        try:
            ...
            for entry in self.entries_cache:
                ...
                if (
                    ...
                    or search_term in content.lower()
                    or any(search_term in tag.lower() for tag in tags if isinstance(tag, str))
                ):
