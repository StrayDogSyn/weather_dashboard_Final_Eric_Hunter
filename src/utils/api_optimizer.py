    ...
    def clear_cache(self, pattern: Optional[str] = None) -> int:
        ...
        with self._cache_lock:
            if pattern:
                ...
                to_remove = [
                    key for key in self._request_cache.keys()
                    if pattern in key
                ]
...
def create_weather_request(location: str, priority: RequestPriority = RequestPriority.HIGH) -> APIRequest:
