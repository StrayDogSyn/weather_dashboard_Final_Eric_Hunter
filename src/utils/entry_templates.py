...
Travel Weather Rating: [Rate 1-10]""",
            ...
            weather_focus=["temperature", "conditions", "wind_speed", "visibility", "precipitation"],
...
Quick Rating: [Rate today's weather 1-10]""",
    ...
    def apply_template(self, template_id: str, weather_data: Optional[Dict[str, Any]] = None,
                      custom_values: Optional[Dict[str, str]] = None) -> Optional[Dict[str, Any]]:
    ...
    def search_templates(self, query: str) -> Dict[str, EntryTemplate]:
        ...
        for template_id, template in self.templates.items():
            if (query_lower in template.name.lower() or
                ...
                any(query_lower in tag.lower() for tag in template.suggested_tags)):
                matching_templates[template_id] = template
        
        return matching_templates
    
    def get_template_suggestions(self, weather_data: Optional[Dict[str, Any]] = None,
                               activity_type: Optional[str] = None) -> List[str]:
        ...
        if activity_type:
            ...
            elif any(word in activity_lower for word in ['outdoor', 'hike', 'run', 'bike', 'sport']):
