...
class CacheManager:
    ...
    def __init__(self, max_size_mb: int = 100, enable_compression: bool = True, 
                 compression_threshold: int = 1024, lru_factor: float = 0.8):
        """
    ...
    def _determine_compression(self, value: Any) -> CompressionType:
        ...
        # Estimate size
        estimated_size = len(str(value)) if isinstance(value, (str, int, float)) else len(json.dumps(value, default=str))
