...
class AtmosphericDTO:
    ...
    @classmethod
    def from_openweather(cls, main_data: Dict[str, Any], visibility: Optional[float] = None) -> "AtmosphericDTO":
...
class PrecipitationDTO:
    ...
    @classmethod
    def from_openweather(cls, rain_data: Optional[Dict[str, Any]] = None, 
                        snow_data: Optional[Dict[str, Any]] = None,
                        pop: Optional[float] = None) -> "PrecipitationDTO":
...
class WeatherResponseDTO:
    ...
    @classmethod
    def from_openweather_current(cls, data: Dict[str, Any], response_time_ms: Optional[float] = None) -> "WeatherResponseDTO":
    ...
    @classmethod
    def from_openweather_forecast(cls, data: Dict[str, Any], response_time_ms: Optional[float] = None) -> "WeatherResponseDTO":
    ...
    @classmethod
    def from_openweather_onecall(cls, data: Dict[str, Any], response_time_ms: Optional[float] = None) -> "WeatherResponseDTO":
        """Create from OpenWeather One Call API response."""
